...
def create_tables():
    ...
    if conn:
        try:
            ...
            if count == 0:
                # Complete strain list from attached file plus popular strains
                comprehensive_strains = [
                    # Popular strains marked as such
                    ...
                    (None, 'Godfather OG', 'Indica', True),  # Added the missing popular strain
                    
                    # Complete list from attached file - alphabetically sorted
